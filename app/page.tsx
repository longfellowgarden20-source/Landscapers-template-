      ...
      <section className="py-20 bg-blue-50 border-t border-blue-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Link href="/about" className="group block rounded-3xl border-2 border-blue-200 bg-white p-8 hover:border-accent hover:shadow-[0_8px_30px_-8px_rgba(96,165,250,0.3)] transition">
            ...
            <Link href="/services" className="group block rounded-3xl border-2 border-blue-200 bg-white p-8 hover:border-accent hover:shadow-[0_8px_30px_-8px_rgba(96,165,250,0.3)] transition">
            ...
            <Link href="/pricing" className="group block rounded-3xl border-2 border-blue-200 bg-white p-8 hover:border-accent hover:shadow-[0_8px_30px_-8px_rgba(96,165,250,0.3)] transition">
            ...
            <Link href="/why-us" className="group block rounded-3xl border-2 border-blue-200 bg-white p-8 hover:border-accent hover:shadow-[0_8px_30px_-8px_rgba(96,165,250,0.3)] transition">
