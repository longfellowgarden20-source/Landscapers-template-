            ...
            <div className="grid gap-3">
              {business.services.map((s) => (
                <button
                  ...
                  className={`w-full text-left px-5 py-4 rounded-2xl border-2 font-medium transition-all duration-200 ${service === s ? 'border-accent bg-green-50 text-accent' : 'border-slate-200 text-slate-700 hover:border-accent/50 hover:bg-slate-50'}`}
                >
                  {s}
                </button>
              ))}
