...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className={`border-2 rounded-2xl transition-all duration-200 ${open ? 'border-accent bg-green-50' : 'border-slate-100 bg-white hover:border-slate-200'}`}>
      <button
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-green-800 via-green-700 to-green-900 py-14 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-green-200 text-sm uppercase tracking-widest font-semibold mb-3">FAQ</p>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        {/* CTA */}
        <div className="mt-14 rounded-3xl bg-green-50 border-2 border-green-100 p-8 sm:p-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/book"
              className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-accent text-white font-semibold text-sm hover:bg-accent-dark transition"
            >
              Book a Free Consultation
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-3 rounded-full border-2 border-slate-200 text-slate-700 font-semibold text-sm hover:bg-slate-50 transition"
            >
              Contact Us
            </Link>
          </div>
